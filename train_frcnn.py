...
parser.add_option("--num_epochs", type="int", dest="num_epochs",
                  help="Number of epochs.", default=5)  # default=2000 #1st custom:500
...
data_gen_train = data_generators.get_anchor_gt(
    train_imgs, classes_count, C, nn.get_img_output_length, K.common.image_dim_ordering(), mode='train')
...
for epoch_num in range(num_epochs):
    ...
    while True:
        try:
            ...
            R = roi_helpers.rpn_to_roi(P_rpn[0], P_rpn[1], C, K.common.image_dim_ordering(
